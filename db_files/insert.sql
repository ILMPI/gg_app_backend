...
INSERT INTO `membership` (`users_id`, `groups_id`, `status`)
VALUES 
-- Members for Grupo de Juan
((SELECT id FROM `users` WHERE name = 'María López'), (SELECT id FROM `groups` WHERE title = 'Grupo de Juan'), 'Joined'),
((SELECT id FROM `users` WHERE name = 'Carlos García'), (SELECT id FROM `groups` WHERE title = 'Grupo de Juan'), 'Joined'),
-- Members for Grupo de María
((SELECT id FROM `users` WHERE name = 'Juan Pérez'), (SELECT id FROM `groups` WHERE title = 'Grupo de María'), 'Joined'),
((SELECT id FROM `users` WHERE name = 'Ana Fernández'), (SELECT id FROM `groups` WHERE title = 'Grupo de María'), 'Joined'),
-- Members for Grupo de Carlos
((SELECT id FROM `users` WHERE name = 'Luis Martínez'), (SELECT id FROM `groups` WHERE title = 'Grupo de Carlos'), 'Joined'),
((SELECT id FROM `users` WHERE name = 'Ana Fernández'), (SELECT id FROM `groups` WHERE title = 'Grupo de Carlos'), 'Joined'),
-- Members for Grupo de Ana
((SELECT id FROM `users` WHERE name = 'Carlos García'), (SELECT id FROM `groups` WHERE title = 'Grupo de Ana'), 'Joined'),
((SELECT id FROM `users` WHERE name = 'Luis Martínez'), (SELECT id FROM `groups` WHERE title = 'Grupo de Ana'), 'Joined'),
-- Members for Grupo de Luis
((SELECT id FROM `users` WHERE name = 'Juan Pérez'), (SELECT id FROM `groups` WHERE title = 'Grupo de Luis'), 'Joined'),
((SELECT id FROM `users` WHERE name = 'María López'), (SELECT id FROM `groups` WHERE title = 'Grupo de Luis'), 'Joined');

-- Insert expenses for each group
INSERT INTO `expenses` (`groups_id`, `concept`, `amount`, `date`, `max_date`, `image_url`, `membership_users_id`, `created_on`)
VALUES 
